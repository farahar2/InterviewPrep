<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <h2 class="font-bold text-3xl text-gray-900 dark:text-white">Edit Concept</h2>
        </div>
    </x-slot>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-dark-700 border-2 border-gray-200 dark:border-dark-600 rounded-xl text-center transition-all duration-200
                                        peer-checked:border-difficulty-junior peer-checked:bg-difficulty-junior/5
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-dark-700 border-2 border-gray-200 dark:border-dark-600 rounded-xl text-center transition-all duration-200
                                        peer-checked:border-difficulty-mid peer-checked:bg-difficulty-mid/5
                                        hover:border-gray-300 dark:hover:border-dark-500">
                                <div class="text-2xl mb-2">🟡</div>
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-dark-700 border-2 border-gray-200 dark:border-dark-600 rounded-xl text-center transition-all duration-200
                                        peer-checked:border-difficulty-senior peer-checked:bg-difficulty-senior/5
                                        hover:border-gray-300 dark:hover:border-dark-500">
                                <div class="text-2xl mb-2">🔴</div>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <label class="relative cursor-pointer">
                            <input type="radio"
                                   ...
                                   required>
                            <div class="p-4 bg-gray-50 dark:bg-dark-700 border-2 border-gray-200 dark:border-dark-600 rounded-xl text-center transition-all duration-200
                                        peer-checked:border-status-review peer-checked:bg-status-review/5
                                        hover:border-gray-300 dark:hover:border-dark-500">
                                <div class="font-semibold text-gray-900 dark:text-white">To Review</div>
                                <div class="text-xs text-gray-500 dark:text-dark-400 mt-1">Need to study</div>
                            </div>
                        </label>
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-dark-700 border-2 border-gray-200 dark:border-dark-600 rounded-xl text-center transition-all duration-200
                                        peer-checked:border-status-progress peer-checked:bg-status-progress/5
                                        hover:border-gray-300 dark:hover:border-dark-500">
                                <div class="font-semibold text-gray-900 dark:text-white">In Progress</div>
                                <div class="text-xs text-gray-500 dark:text-dark-400 mt-1">Learning</div>
                            </div>
                        </label>
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-dark-700 border-2 border-gray-200 dark:border-dark-600 rounded-xl text-center transition-all duration-200
                                        peer-checked:border-status-mastered peer-checked:bg-status-mastered/5
                                        hover:border-gray-300 dark:hover:border-dark-500">
                                <div class="font-semibold text-gray-900 dark:text-white">Mastered</div>
                                <div class="text-xs text-gray-500 dark:text-dark-400 mt-1">Confident</div>
                            </div>
                        </label>
                    </div>
                    @error('status')
